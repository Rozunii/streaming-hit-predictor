...
Arquitectura: \texttt{Dense(128) -> Dropout(0.3) -> Dense(64) -> Dropout(0.2) -> Dense(3, softmax)}. Se usaron class weights balanceados para corregir el sesgo hacia la clase Medio (50\% del dataset), con \texttt{EarlyStopping(patience=20)} y \texttt{ReduceLROnPlateau}. El modelo convergio en 43 epocas.
